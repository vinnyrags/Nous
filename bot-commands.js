...
const messages = [
    ...
    // Message 2: Master Commands
    {
        ...
        description: [
            ...
            '',
            '**`/live`** — Go live. Posts pre-order summary, starts livestream session, posts Whatnot show link + itzenzo.tv catalog link in `#announcements` so buyers know where to watch.',
            '',
            '**`/offline`** — End live show. Closes livestream session, ensures a queue is open for pre-orders, posts show-ended in `#announcements`, posts recap to `#analytics`.',
        ].join('\n'),
        color: 0xceff00,
    },
