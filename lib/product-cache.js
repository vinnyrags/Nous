...
import { listActiveProducts } from '@itzenzottv/stripe-bridge';
...
export async function refresh() {
    ...
    refreshInFlight = (async () => {
        try {
            ...
            // Package owns the Stripe fetch + pagination; we own the cache shape
            // (lowerName for prefix matching) and the autocomplete suggest().
